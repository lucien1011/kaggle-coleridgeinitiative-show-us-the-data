...
name = "TokenBinaryClass_conv1d_distilbert_base_uncased_210522_01"
base_pretrained = "distilbert-base-uncased"
plot_label = "distilBert-base-uncased-conv1d-4layer"

t2_dir = "/cmsuf/data/store/user/t2/users/klo/MiscStorage/ForLucien/Kaggle/coleridgeinitiative-show-us-the-data/data/"
preprocess_train_dir = os.path.join(t2_dir,"TokenBinaryClass_conv1d_distilbert_base_uncased_210522_01","train/")
preprocess_test_dir = os.path.join(t2_dir,"TokenBinaryClass_conv1d_distilbert_base_uncased_210522_01","test/")
