...
config = ObjDict(
    ...
    name = "optimise_classifier_210502_smallbert_en_uncased_L12_H128_A2",
    ...
    saved_model_path = 'saved_model/optimise_classifier_210502_smallbert_en_uncased_L12_H128_A2',
    saved_history_path = 'saved_model/optimise_classifier_210502_smallbert_en_uncased_L12_H128_A2/history.p',
