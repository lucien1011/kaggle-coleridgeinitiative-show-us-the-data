...
name = "TokenBinaryClass_bertmask_base_uncased"
...
model = BertForMaskTokenClassification.from_pretrained('model/'+base_pretrained,num_labels=len(label_list),hidden_dropout_prob=0.5)
