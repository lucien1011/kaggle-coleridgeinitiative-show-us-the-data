...
name = "TokenBinaryClass_bert_base_uncased_12hiddenout"
...
preprocess_cfg = ObjDict(
        tokenizer = tokenizer,
        train_csv_path = "storage/input/pack_data_210605/train_sequence.csv",
        preprocess_train_dir = preprocess_train_dir,
        test_csv_path = 'storage/input/pack_data_210605/test_sequence.csv',
