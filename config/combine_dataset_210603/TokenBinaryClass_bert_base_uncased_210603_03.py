...
preprocess_train_dir = os.path.join(t2_dir,"combine_dataset_210601","TokenBinaryClass_bert_base_uncased","train/")
preprocess_test_dir = os.path.join(t2_dir,"combine_dataset_210601","TokenBinaryClass_bert_base_uncased","test/")
