...
name = "optimise_tokenclassification_210510_01_hasDataset"
...
preprocess_train_dir = "data/optimise_tokenclassification_210510_01_hasDataset/train/" 
preprocess_test_dir = "data/optimise_tokenclassification_210510_01_hasDataset/test/" 
label_list = [0,1]
...
preprocess_cfg = ObjDict(
    train_csv_path = "data/train_hasDataset.csv",
    train_size = 0.8,
    val_size = 0.1,
    tokenizer = tokenizer,
