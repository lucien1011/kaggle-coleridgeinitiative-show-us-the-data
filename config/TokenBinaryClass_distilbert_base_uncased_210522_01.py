...
from transformers import DistilBertForTokenClassification,DistilBertTokenizerFast,DistilBertConfig,BertModel

from pipeline.pipeline_tokenmulticlassifier import TokenMultiClassifierPipeline
from utils.objdict import ObjDict

# __________________________________________________________________ ||
name = "TokenBinaryClass_distilbert_base_uncased_210522_01"
base_pretrained = "distilbert-base-uncased"
plot_label = "distilbert-base-uncased-linear"

t2_dir = "/cmsuf/data/store/user/t2/users/klo/MiscStorage/ForLucien/Kaggle/coleridgeinitiative-show-us-the-data/data/"
preprocess_train_dir = os.path.join(t2_dir,"TokenBinaryClass_distilbert_base_uncased_210522_01","train/")
preprocess_test_dir = os.path.join(t2_dir,"TokenBinaryClass_distilbert_base_uncased_210522_01","test/")
