...
base_dir = "train_dataset_externalcv_210603"
name = "TokenBinaryClass_bert_base_uncased_maskdatasetname"
...
preprocess_train_dir = os.path.join(t2_dir,base_dir,"TokenBinaryClass_bert_base_uncased_filter/","train/")
preprocess_test_dir = os.path.join(t2_dir,base_dir,"TokenBinaryClass_bert_base_uncased","test/")
