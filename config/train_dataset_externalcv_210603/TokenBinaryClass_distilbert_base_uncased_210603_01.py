...
from transformers import DistilBertForTokenClassification,DistilBertTokenizerFast,DistilBertConfig,DistilBertModel,DistilBertConfig

from pipeline.pipeline_tokenmulticlassifier import TokenMultiClassifierPipeline
from utils.objdict import ObjDict

# __________________________________________________________________ ||
base_dir = "train_external_dataset_cv_210603/"
name = "TokenBinaryClass_distilbert_base_uncased"
...
preprocess_train_dir = os.path.join(t2_dir,"combine_dataset_210601","TokenBinaryClass_distilbert_base_uncased","test/")
preprocess_test_dir = os.path.join(t2_dir,"combine_dataset_210601","TokenBinaryClass_distilbert_base_uncased","train/")
