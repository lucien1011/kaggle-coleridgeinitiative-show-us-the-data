...
from model.DistilBertCNNForTokenClassification import DistilBertCNNForTokenClassification
...
name = "optimise_TokenMultiClass_DistilBertCNNv1_base_uncased_210514"
...
extract_cfg = ObjDict(
        ...
        write_per_step = 1,
        extract_rext_path = os.path.join('tmp',name+'_extract_test_8000.txt'),
        )
