...
from model.BertCustomLoss import BertForTokenClassification
...
name = "IoULoss_bert_210528_01"
base_pretrained = "bert-base-uncased"
plot_label = "IoULoss_bert-base-uncased_rand-frac-0.1"
...
model = BertForTokenClassification.from_pretrained('model/'+base_pretrained)
