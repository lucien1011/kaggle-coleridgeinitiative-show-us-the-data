...
name = "TokenBinaryClass_conv1d_bert_210528_05"
base_pretrained = "bert-base-uncased"
plot_label = "bert-base-uncased-conv1d-4layer-kernel8_rand-frac-0.1"
...
config = BertConv1dConfig(
        num_labels = nlabel,
        conv_setting = [
            {"in_channels":768, "out_channels":512, "kernel_size":5,},
            {"in_channels":512, "out_channels":256, "kernel_size":5,},
            {"in_channels":256, "out_channels":128, "kernel_size":5,},
            {"in_channels":128, "out_channels":nlabel, "kernel_size":5,},
            ],
        )
model = BertConv1dForTokenClassification(config)
