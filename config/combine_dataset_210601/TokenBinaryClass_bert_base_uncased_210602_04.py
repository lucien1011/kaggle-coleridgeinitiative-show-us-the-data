...
name = "TokenBinaryClass_bert_base_uncased_210602_04"
base_pretrained = "bert-base-uncased"
plot_label = "bert-base-uncased-linear_rand-frac-0.5"

t2_dir = "/cmsuf/data/store/user/t2/users/klo/MiscStorage/ForLucien/Kaggle/coleridgeinitiative-show-us-the-data/data/"
preprocess_train_dir = os.path.join(t2_dir,base_dir,"TokenBinaryClass_bert_base_uncased_210602_02/","train/")
#preprocess_test_dir = os.path.join(t2_dir,base_dir,"TokenBinaryClass_bert_base_uncased_210602_03","test/")
preprocess_test_dir = os.path.join(t2_dir,base_dir,"TokenBinaryClass_bert_base_uncased_210602_02","test/")
...
preprocess_cfg = ObjDict(
        ...
        test_csv_path = "storage/data/combine_dataset/test_sequence_test_dataset_only.csv",
