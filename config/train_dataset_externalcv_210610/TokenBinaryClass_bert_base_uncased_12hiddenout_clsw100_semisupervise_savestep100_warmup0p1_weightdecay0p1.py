...
name = "TokenBinaryClass_bert_base_uncased_12hiddenout_semisupervise_savestep100_warmup0p1_weightdecay0p1"
...
#preprocess_train_dir = os.path.join(t2_dir,"train_dataset_externalcv_210610","TokenBinaryClass_bert_base_uncased","train/")
preprocess_train_dir = os.path.join(t2_dir,"train_dataset_externalcv_210610","TokenBinaryClass_bert_base_uncased","train_filter_by_train_dataset/")
#preprocess_test_dir = os.path.join(t2_dir,"train_dataset_externalcv_210610","TokenBinaryClass_bert_base_uncased","test/")
...
model = CustomBertForTokenClassification.from_pretrained('model/'+base_pretrained,num_labels=len(label_list),output_hidden_states=True,)
