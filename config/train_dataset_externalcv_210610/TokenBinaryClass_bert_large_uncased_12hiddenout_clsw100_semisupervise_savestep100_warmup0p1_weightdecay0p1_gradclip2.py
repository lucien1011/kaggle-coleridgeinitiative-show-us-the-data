...
name = "TokenBinaryClass_bert_large_uncased_12hiddenout_clsw100_semisupervise_savestep100_warmup0p1_weightdecay0p1_gradclip2"
...
model_args = dict(num_labels=len(label_list),output_hidden_states=True,use_all_attention=True,class_weight=class_weight)
