...
preprocess_train_dir = os.path.join(t2_dir,"TokenBinaryClass_bert_large_uncased_210522_01","train/")
preprocess_test_dir = os.path.join(t2_dir,"TokenBinaryClass_bert_large_uncased_210522_01","test/")
