...
name = "optimise_tokenclassification_210508_01_hasDataset"
...
#model = AutoModelForTokenClassification.from_pretrained(base_pretrained, num_labels=len(label_list))
...
preprocess_cfg = ObjDict(
    ...
    val_size = 0.1,
    tokenizer = tokenizer,
    save_preprocess_path = os.path.join('data/',name),
