...
name = "TokenBinaryClass_bert_base_uncased_clsw100_semisupervise_lr2e6"
...
model = CustomBertForTokenClassification.from_pretrained('model/'+base_pretrained,num_labels=len(label_list),output_hidden_states=True,class_weight=class_weight,use_all_attention=False)
